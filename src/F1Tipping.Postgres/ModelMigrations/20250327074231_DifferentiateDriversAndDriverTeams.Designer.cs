...
namespace F1Tipping.Postgres.ModelMigrations
{
    ...
    [Migration("20250327074231_DifferentiateDriversAndDriverTeams")]
    partial class DifferentiateDriversAndDriverTeams
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("F1Tipping.Model.DriverTeam", b =>
                {
                    ...
                    b.HasIndex("DriverId")
                        .HasDatabaseName("ix_racingentities_driverid");
            ...
            modelBuilder.Entity("F1Tipping.Model.DriverTeam", b =>
                {
                    b.HasOne("F1Tipping.Model.Driver", "Driver")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_racingentities_drivers_driverid");
