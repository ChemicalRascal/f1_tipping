...
namespace F1Tipping.Postgres.AppMigrations
{
    ...
    [Migration("20251230114650_AddSeasonSelection")]
    partial class AddSeasonSelection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("F1Tipping.Data.GlobalTemporalData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<Guid?>("LastNotifiedRoundId")
                        .HasColumnType("uuid")
                        .HasColumnName("lastnotifiedroundid");

                    b.HasKey("Id")
                        .HasName("pk_globaltemporaldata");

                    b.ToTable("globaltemporaldata", (string)null);
                });
            ...
            modelBuilder.Entity("F1Tipping.Data.AppModel.User", b =>
                {
                    b.OwnsOne("F1Tipping.Data.AppModel.TemporalUserData", "TemporalData", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");

                            b1.Property<DateTimeOffset?>("LastNotification")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("temporaldata_lastnotification");

                            b1.Property<DateTimeOffset?>("NextNotification")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("temporaldata_nextnotification");
                    ...
                    b.OwnsOne("F1Tipping.Data.AppModel.UserSettings", "Settings", b1 =>
                        {
                            ...
                            b1.OwnsOne("F1Tipping.Data.AppModel.NotificationsSettings", "NotificationsSettings", b2 =>
                                {
                                    ...
                                    b2.Property<TimeSpan>("MinimumTimeBetweenNotifications")
                                        .HasColumnType("interval")
                                        .HasColumnName("settings_notificationssettings_minimumtimebetweennotifications");
                            ...
                            b1.OwnsOne("F1Tipping.Data.AppModel.SystemSettings", "SystemSettings", b2 =>
                                {
                                    b2.Property<Guid>("UserSettingsUserId")
                                        .HasColumnType("uuid")
                                        .HasColumnName("id");

                                    b2.Property<Guid>("SelectedSeason")
                                        .HasColumnType("uuid")
                                        .HasColumnName("settings_systemsettings_selectedseason");
                            ...
                            b1.Navigation("SystemSettings");
                        });

                    b.Navigation("Settings")
                        .IsRequired();

                    b.Navigation("TemporalData")
                        .IsRequired();
                });
